 ...
 */
low.ui.getElementByFragment = function(component, idFragment) {
  var root = component.getElement();
  if (!root) {
    throw Error('The component does not have its element set.');
  }
  return low.ui.getElement(component.makeId(idFragment), root);
};
 ...
 * @return {Element} The element, if found.
 */
low.ui.getElement = function(id, opt_root) {
